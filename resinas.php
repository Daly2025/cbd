...
<head>
    ...
    <title>Tienda CBD - Resinas</title>
    <style>
...
<body>
    ...
    <div class="container">
        <h1>Resinas CBD</h1>
        <p>Descubre nuestra variedad de resinas CBD.</p>
        ...
        <div class="product-grid">
            <!-- 20 Productos de ejemplo para Resinas CBD -->
            <?php for ($i = 1; $i <= 20; $i++): ?>
                <div class="product-card">
                    <img src="img/resina_cbd_<?php echo $i; ?>.jpg" alt="Resina CBD <?php echo $i; ?>">
                    <h3>Resina CBD Ejemplo <?php echo $i; ?></h3>
                    <p>Descripción de la resina CBD número <?php echo $i; ?>.</p>
                    <div class="price"><?php echo rand(20, 70); ?>,00 €</div>
