...
<body>
    ...
    <div class="container">
        <h1>Vapers CBD</h1>
        <p>Encuentra los mejores vapers y líquidos CBD.</p>
        ...
        <div class="product-grid">
            <!-- 20 Productos de ejemplo para Vapers CBD -->
            <?php for ($i = 1; $i <= 20; $i++): ?>
                <div class="product-card">
                    <img src="img/vaper_cbd_<?php echo $i; ?>.jpg" alt="Vaper CBD <?php echo $i; ?>">
                    <h3>Vaper CBD Ejemplo <?php echo $i; ?></h3>
                    <p>Descripción del vaper CBD número <?php echo $i; ?>.</p>
                    <div class="price"><?php echo rand(25, 80); ?>,00 €</div>
